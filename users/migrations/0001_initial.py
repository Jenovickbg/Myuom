# Generated by Django 3.1.12 on 2025-10-02 18:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('matricule', models.CharField(help_text='Matricule unique (ex: UOM2025-001)', max_length=15, unique=True, validators=[django.core.validators.RegexValidator(message='Le matricule doit être au format UOM2025-001', regex='^UOM\\d{4}-\\d{3}$')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('code', models.CharField(help_text='Code de la faculté (ex: FSI)', max_length=10, unique=True)),
                ('nom', models.CharField(help_text='Nom complet de la faculté', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('photo', models.ImageField(blank=True, help_text='Photo de profil', null=True, upload_to='profiles/students/%Y/%m/')),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('faculte', models.ForeignKey(blank=True, help_text="Faculté d'appartenance", null=True, on_delete=django.db.models.deletion.SET_NULL, to='users.faculte')),
                ('promotion', models.ForeignKey(blank=True, help_text="Promotion d'appartenance", null=True, on_delete=django.db.models.deletion.SET_NULL, to='users.promotion')),
